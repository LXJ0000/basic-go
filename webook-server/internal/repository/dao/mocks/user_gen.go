...
func (m *MockUserDao) FindByUserId(ctx context.Context, userId int64) (dao.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserDaoMockRecorder) FindByUserId(ctx, userId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindByUserId", reflect.TypeOf((*MockUserDao)(nil).FindByUserId), ctx, userId)
}
