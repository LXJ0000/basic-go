...
func (m *MockUserRepository) FindByUserId(ctx context.Context, userId int64) (domain.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserRepositoryMockRecorder) FindByUserId(ctx, userId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
